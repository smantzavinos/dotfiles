...
in {
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/5d03ec1c-b551-4937-9fdf-2c59cc4f921e";
      fsType = "ext4";
    };

  boot.initrd.luks.devices."luks-73dffaf9-1512-4104-ae36-b4370c436510".device = "/dev/disk/by-uuid/73dffaf9-1512-4104-ae36-b4370c436510";

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/B567-DA5A";
      fsType = "vfat";
      options = [ "fmask=0077" "dmask=0077" ];
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/1977f329-5709-421c-8900-11018f1f914c"; }
    ];
